...
function FindYourPerfectMatchContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center justify-center leading-[normal] relative shrink-0 text-nowrap whitespace-pre" data-name="Find Your Perfect Match Container">
      <p className="font-['Playfair_Display:Regular',_sans-serif] font-normal relative shrink-0 text-[#2a120a] text-[60px]">Find Your Perfect Match</p>
      <p className="font-['Inter:Light',_sans-serif] font-light not-italic relative shrink-0 text-[#7c563d] text-[40px]">Shop by Categories</p>
    </div>
  );
}
  ...
  return (
    <div className="basis-0 content-stretch flex flex-col grow items-center justify-end min-h-px min-w-px overflow-clip relative rounded-[26.133px] shrink-0" data-name="CARD 1">
      <div className="h-[450px] relative shrink-0 w-full" data-name="Vector">
        <img alt="" className="block max-w-none size-full" height="450" src={imgVector} width="453.333" />
      </div>
      <EarringsCard />
    </div>
  );
  ...
  return (
    <div className="relative size-full" data-name="Main container">
      <div className="flex flex-col items-end size-full">
        <div className="box-border content-stretch flex flex-col gap-[32px] items-end px-[96px] py-0 relative size-full">
          <Heading />
          <Cards />
          <Cards1 />
        </div>
